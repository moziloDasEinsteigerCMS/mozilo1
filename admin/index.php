...
#        }
    ...
    .'<tr><td>'.getLanguageValue("config_input_contact_text").'</td><td><input type="text" class="input_cms_text" name="name" value="'.$specialchars->rebuildSpecialChars($config_name[0],true,true).'"'.$error_color['titel_name'].' /></td><td align="center">'.buildCheckBox("show_name", ($config_name[1] == "true")).'</td><td align="center">'.buildCheckBox("mandatory_name", ($config_name[2] == "true")).'</td></tr>'
